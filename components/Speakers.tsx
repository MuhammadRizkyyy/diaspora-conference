        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {SPEAKERS.map((speaker, i) => {
            ...
            <div
              ...
              data-idx={i}
              className={`bg-brand-cream p-8 rounded-xl shadow-sm border border-brand-gold/20 flex items-center gap-6 transition-all duration-[800ms] ease-out ${
                visible[i]
            ...
            >
              <div className="w-28 h-32 shrink-0 rounded-lg bg-gradient-to-tr from-brand-charcoal to-brand-gold-dark flex items-center justify-center text-brand-gold text-4xl">
              ...
              <div className="text-left flex-1">
                ...
                <div className="flex gap-2">
                  <a className="w-7 h-7 rounded-full bg-brand-charcoal text-brand-gold flex items-center justify-center text-xs" href="#">
                    <i className="fa-brands fa-linkedin-in"></i>
                  </a>
                  <a className="w-7 h-7 rounded-full bg-brand-gold text-brand-charcoal flex items-center justify-center text-xs" href="#">
